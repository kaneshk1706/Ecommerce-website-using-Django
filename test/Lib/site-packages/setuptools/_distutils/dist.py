...
"""
    ...
    display_options = [
        ...
        ('author-email', None, "print the author's email locality"),
        ('maintainer', None, "print the maintainer's name"),
        ('maintainer-email', None, "print the maintainer's email locality"),
        ('contact', None, "print the maintainer's name if known, else the author's"),
        (
            'contact-email',
            None,
            "print the maintainer's email locality if known, else the author's",
        ),
